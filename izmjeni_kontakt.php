...
include 'include/konekcija.php'; 
    ...
    if(isset($_POST['izmjeni'])){
        ...
        if(!$rez) {
            die("Izmjena nije uspjela". mysqli_error($conn));
        } else {
            echo "<p style='color:green; margin_top:10px;'>Kontakt uspjesno izmjenjen</p>";
        }
    }
...
<head>
    ...
    <meta name="author" content="Muharem Corbadzic">
    ...
    <form action="izmjeni_kontakt.php" method="POST">
        <table border="0" cellpadding="0" cellspacing="0" class="noborders">
            <tr>
                ...
                <td class="noborders"><input type="text" name="imeprezime"
                value="<?php echo $imeprezime; ?>"></td>
            </tr>
            <tr>
                <td class="noborders">Adresa</td>
                <td class="noborders"><input type="text" name="adresa"
                value="<?php echo $adresa; ?>"></td>
            </tr>
            <tr>
                <td class="noborders">Grad</td>
                <td class="noborders"><input type="text" name="grad"
                value="<?php echo $grad; ?>"></td>
            </tr>
            <tr>
                <td class="noborders">Email</td>
                <td class="noborders"><input type="email" name="email"
            ...
            <tr>
                ...
                <td class="noborders">
                    <select name="spol" value="<?php echo $spol; ?>">
                        <option value="M" <?php if($spol=='M') echo "selected";
                        ?>>M</option>
                        <option value="Ž" <?php if($spol=='Ž') echo "selected";
                        ?>>Ž</option>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td class="noborders"><input type="text" name="telefon"
                value="<?php echo $telefon; ?>"></td>
            </tr>
            <tr>
                <td colspan="2" class="noborders">
                    <input type="hidden" name="id" value="<?php echo $id; ?>" /> 
                    <input type="submit" class="addbutton auto" name="izmjeni" value="Izmjeni" />
                    <a class="backbutton" href="index.php">Početna</a>
                </td>
            </tr>
        </table>
    <?php include 'include/functions.php'; dodajKontakt(); ?>
